...
public class UserController {
	...
	@GetMapping("/sample/monwil")
	public String paramterizedUrl( @RequestParam("name") String pangalan,
			@RequestParam("surname") String apelyido
	) { 
		
		String yourName = "Your name is " + pangalan + " " + apelyido;
		return yourName;
	}
